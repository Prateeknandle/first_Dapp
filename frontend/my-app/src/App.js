  ...
  const wave = async () => {
    try {
      ...
      if (ethereum) {
        ...
        const waveTxn = await wavePortalContract.wave("message for you!!", { gasLimit: 300000 });
  ...
  return (
    <div className="mainContainer">
      <div className="dataContainer">
        ...
        <div className="bio">
          Myself Prateek Nandle and I'm an Open-source contributor and an aspiring Blockchain Enginner.
        </div>
